    ...
    public partial class KhachHang : Form
    {
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (listView1.SelectedItems.Count > 0)
            {
                ...
                cbo_phanloai.Text = listView1.SelectedItems[0].SubItems[3].Text;
                txt_diachi.Text = listView1.SelectedItems[0].SubItems[4].Text;
                txt_dth.Text = listView1.SelectedItems[0].SubItems[5].Text;
            }
        }
